...
phaseGeneration.push(()=>{
    ...
    openDoors = [];
    doors = [];
    doors.push(new (0, $6dfM7.default)());
...
const $486031900c58675e$var$stonePath = new URL((parcelRequire("7fEdV"))).toString();
let $486031900c58675e$var$cubeMaterials = [
    $486031900c58675e$var$setMaterial("lightgray", $486031900c58675e$var$stonePath, 2, 1),
    $486031900c58675e$var$setMaterial("lightgray", $486031900c58675e$var$stonePath),
    $486031900c58675e$var$setMaterial("lightgray", $486031900c58675e$var$stonePath, 0, 1),
...
class $486031900c58675e$var$CranckTorus extends $49pUz.Mesh {
    constructor(){
        super(new $49pUz.TorusGeometry(0.22, 0.05, 10, 20), new $49pUz.MeshPhongMaterial({
            color: "red"
        }));
    }
}
...
class $486031900c58675e$var$Cranck extends $49pUz.Object3D {
    constructor(type){
        super();
        this.index = 0;
        this.x = 0;
        ...
        this.type = type;
        // cranck torus
        let cranckTorus = new $486031900c58675e$var$CranckTorus;
        cranckTorus.position.set(0, 0, 0);
        // cranck cylinders
        let CranckCylinder1 = new $486031900c58675e$var$CranckCylinder;
        CranckCylinder1.position.set(0, 0.08, 0);
        let CranckCylinder2 = new $486031900c58675e$var$CranckCylinder;
        CranckCylinder2.rotateZ(Math.PI / 3.5);
        CranckCylinder2.position.set(0.08, -0.05, 0);
        let CranckCylinder3 = new $486031900c58675e$var$CranckCylinder;
        CranckCylinder3.rotateZ(Math.PI / -3.5);
        CranckCylinder3.position.set(-0.08, -0.05, 0);
        let CranckCylinder4 = new $486031900c58675e$var$CranckCylinder(0.05, 0.05, 0.06, 12, 12, "red");
        CranckCylinder4.rotateX(Math.PI / 2);
        CranckCylinder4.position.set(0, 0, 0);
        let CranckCylinder5 = new $486031900c58675e$var$CranckCylinder(0.035, 0.035, 0.061, 12, 12, "lightgray");
        CranckCylinder5.rotateX(Math.PI / 2);
        CranckCylinder5.position.set(0, 0, 0);
        let CranckCylinder6 = new $486031900c58675e$var$CranckCylinder(0.028, 0.028, 0.075, 6, 12, "gray");
        CranckCylinder6.rotateX(Math.PI / 2);
        CranckCylinder6.position.set(0, 0, 0);
        let CranckCylinder7 = new $486031900c58675e$var$CranckCylinder(0.02, 0.035, 0.2, 12, 12, "gray");
        CranckCylinder7.rotateX(Math.PI / 2);
        CranckCylinder7.position.set(0, 0, -0.1);
        let CranckCylinder8 = new $486031900c58675e$var$CranckCylinder(0.05, 0.05, 0.07, 6, 12, "gray");
...
class $486031900c58675e$var$CranckDoor extends $49pUz.Object3D {
    constructor(type){
        ...
        // cranck torus
        let cranck = new $486031900c58675e$var$Cranck;
...
parcelRequire.register("7fEdV", function(module, exports) {

module.exports = new URL("../" + (parcelRequire("2JpsI")).resolve("jYLWS"), import.meta.url).toString();
...
var $7a61de2eecd7d1c5$exports = {};

(parcelRequire("2JpsI")).register(JSON.parse('{"jv3CK":"index.8573f923.js","jYLWS":"metal.b1f604da.png","kRsH7":"index.4b671e19.js"}'));
